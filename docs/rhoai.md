...
3) Access the `workbench` named `chatbot-s1744951168968-notebook`.
...
5) In the terminal, run `cd chatbot-s1744951168968` to navigate to your sample app's directory.
